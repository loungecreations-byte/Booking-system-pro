(function($){
  ...
  function applyMeta($root, meta){
    ...
    setMultiSelectValue($root,'combi_deals', meta.combi_deals || []);
    ...
    setFieldValue($root,'base_price_per_person', meta.base_price_per_person);
  ...
  function initResourceSelect($root){
    initEnhancedSelect($root.find('#sbdp-booking-resources'));
  }

  function initCombiSelect($root){
    initEnhancedSelect($root.find('#sbdp-combi-deals'));
  }
