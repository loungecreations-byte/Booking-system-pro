...
use BSP\BookingBoard\Rest\DragController;
...
final class Module implements ModuleInterface
{
    ...
    {
        if (\defined('SBDP_BOOKING_BOARD_V2') && SBDP_BOOKING_BOARD_V2) {
            return;
        }
    ...
    public function enqueueAssets(): void
    {
        ...
        \wp_localize_script(
            ...
            array(
                ...
                'bookingApiBase'  => \rest_url('booking/v1'),
                ...
                'status_labels'   => array(
                    'created'         => __('Aangemaakt', 'sbdp'),
                    'requested'       => __('Aangevraagd', 'sbdp'),
                    'captured'        => __('Geregistreerd', 'sbdp'),
                    'pending'         => __('In behandeling', 'sbdp'),
                    'paid'            => __('Betaald', 'sbdp'),
                    'completed'       => __('Afgerond', 'sbdp'),
                    'fully_confirmed' => __('Volledig bevestigd', 'sbdp'),
                    'cancelled'       => __('Geannuleerd', 'sbdp'),
                ),
            )
        );
    }
    ...
    /**
     * Provide a JS fallback when the Vite manifest cannot be used.
     *
     * @return array{script:string,styles:array<string,string>}
     */
