...
<div class="bsp-claim-form-wrap">
    ...
    <?php if (empty($seeds)) : ?>
        <p><?php esc_html_e('Alle locaties zijn al geclaimed of er zijn nog geen locaties beschikbaar.', 'sbdp'); ?></p>
    <?php else : ?>
        <h2><?php esc_html_e('Claim uw locatie', 'sbdp'); ?></h2>
        <p><?php esc_html_e('Selecteer uw bedrijf uit onderstaande lijst en ontvang een verificatielink per e-mail.', 'sbdp'); ?></p>
