    ...
    public static function registerRoutes(): void
    {
        register_rest_route(
            ...
            array(
                array(
                    ...
                    'args'                => array(
                        'status'        => array('type' => 'string', 'required' => false, 'sanitize_callback' => 'sanitize_text_field'),
                        'with_products' => array('type' => 'boolean', 'required' => false, 'default' => false, 'sanitize_callback' => 'rest_sanitize_boolean'),
                        'per_page'      => array('type' => 'integer', 'required' => false, 'default' => 50, 'sanitize_callback' => 'absint'),
                ...
                array(
                    ...
                    'callback'            => array(__CLASS__, 'createVendor'),
                    'permission_callback' => array(__CLASS__, 'canManage'),
                    'args'                => array(
        ...
        register_rest_route(
            ...
            array(
                ...
                array(
                    ...
                    'callback'            => array(__CLASS__, 'updateVendor'),
                    'permission_callback' => array(__CLASS__, 'canManage'),
                    'args'                => array(
                        'id' => array('type' => 'integer', 'required' => true, 'sanitize_callback' => 'absint'),
                    ),
        ...
        register_rest_route(
            ...
            array(
                array(
                    'methods'             => WP_REST_Server::EDITABLE,
                    'callback'            => array(__CLASS__, 'updateStatus'),
                    'permission_callback' => array(__CLASS__, 'canManage'),
                    'args'                => array(
                        'id'     => array('type' => 'integer', 'required' => true, 'sanitize_callback' => 'absint'),
                        'status' => array('type' => 'string', 'required' => false, 'sanitize_callback' => 'sanitize_text_field'),
        ...
        register_rest_route(
            ...
            array(
                array(
                    'methods'             => WP_REST_Server::EDITABLE,
                    'callback'            => array(__CLASS__, 'syncProducts'),
                    'permission_callback' => array(__CLASS__, 'canManage'),
                    'args'                => array(
                        'id' => array('type' => 'integer', 'required' => true, 'sanitize_callback' => 'absint'),
                    ),
