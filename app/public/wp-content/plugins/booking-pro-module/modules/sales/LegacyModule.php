...
final class LegacyModule implements ModuleInterface {
	...
	private function bootstrapScheduler(): void {
		if ( ! class_exists( Scheduler::class ) ) {
			return;
		}

		if ( ! function_exists( 'add_action' ) ) {
			if ( method_exists( Scheduler::class, 'bootstrap' ) ) {
				Scheduler::bootstrap();
			}
	...
	private function ensureDependencies(): void {
		...
		$classMap = array(
			YieldEngine::class              => 'modules/sales/Pricing/YieldEngine.php',
			PricingRestController::class    => 'modules/sales/Pricing/PricingRestController.php',
			ChannelManager::class           => 'modules/sales/Channels/ChannelManager.php',
			ChannelRestController::class    => 'modules/sales/Channels/RestController.php',
			VendorService::class            => 'modules/sales/Vendors/VendorService.php',
			VendorRestController::class     => 'modules/sales/Vendors/VendorRestController.php',
			VendorRepository::class         => 'modules/sales/Vendors/VendorRepository.php',
			VendorValidator::class          => 'modules/sales/Vendors/VendorValidator.php',
			FunnelTracker::class            => 'modules/sales/Funnels/FunnelTracker.php',
			PromotionsService::class        => 'modules/sales/Promotions/PromotionsService.php',
			PromotionsRestController::class => 'modules/sales/Promotions/PromotionsRestController.php',
			Pages::class                    => 'modules/sales/Admin/Pages.php',
			Scheduler::class                => 'modules/sales/Support/Scheduler.php',
			Installer::class                => 'modules/sales/Support/Installer.php',
			Commands::class                 => 'modules/sales/CLI/Commands.php',
			ReviewManager::class            => 'modules/sales/ReviewManager.php',
		);
...
if ( ! class_exists( 'BSPModule\\Sales\\Module' ) ) {
	class_alias( LegacyModule::class, 'BSPModule\\Sales\\Module' );
}
