...
$bootstrapFiles = array(
    ...
    __DIR__ . '/phpstan-stubs/wp-cli.php',
    __DIR__ . '/phpstan-stubs/wp-rest-controller.php',
);
...
if ( ! class_exists( '\ElementorPro\Modules\ThemeBuilder\Documents\Single_Base' ) ) {
    abstract class ElementorPro_ThemeBuilder_Single_Base {
    ...
    class_alias( 'ElementorPro_ThemeBuilder_Single_Base', '\ElementorPro\Modules\ThemeBuilder\Documents\Single_Base' );
}
