...
final class Installer
{
    public static function install(): void
    {
        ...
        $schemas = [
            ...
            "CREATE TABLE {$wpdb->prefix}bsp_audit_log (
                id BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
            ...
            "CREATE TABLE {$wpdb->prefix}bsp_channel_queue (
                id BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT,
                ...
                PRIMARY KEY (id),
                KEY status (status),
                KEY channel_scheduled (channel_id, scheduled_at),
        ...
        self::seedYieldPresets($wpdb->prefix . 'bsp_yield_rules');
    ...
    private static function seedYieldPresets(string $table): void
    {
        global $wpdb;
        if (! $wpdb instanceof wpdb) {
            return;
        ...
        foreach (PricingPresetRegistry::all() as $preset) {
            $wpdb->insert(
                $table,
                [
                    'name'            => $preset['name'],
                    ...
                    'priority'        => isset($preset['priority']) ? (int) $preset['priority'] : 0,
                    'active'          => isset($preset['active']) ? (int) $preset['active'] : 1,
