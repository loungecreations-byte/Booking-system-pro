...
class SBDP_Resource_Meta {
    ...
    public static function init() {
        ...
        add_action( 'save_post_bookable_resource', [ __CLASS__, 'save' ], 10, 2 );
        add_filter( 'manage_bookable_resource_posts_columns', [ __CLASS__, 'columns' ] );
        add_action( 'manage_bookable_resource_posts_custom_column', [ __CLASS__, 'render_column' ], 10, 2 );
    }
